...
//     let session_id = document.querySelector("#typeEmailX");        // 이메일 입력창
//     let session_pass = document.querySelector("#typePasswordX");   // 비밀번호 입력창

//     if (sessionStorage) {
//         let en_text = encrypt_text(session_pass.value);            // 비밀번호 암호화
//         sessionStorage.setItem("Session_Storage_id", session_id.value);   // 아이디 저장
...
function logout() {
    session_del(); // 세션 삭제 실행
    location.href = '../index6-7.html'; // 메인 페이지로 이동
}